...
namespace Pixel.Studio.Themes.Design
{
    public class VerticalLabel : Label
    {
        ...
        public static readonly DependencyProperty TextOrientationProperty = DependencyProperty.Register("TextOrientation",
            typeof(Direction), typeof(Label), new PropertyMetadata(Direction.Horizontal));
        ...
        public static readonly DependencyProperty TextProperty = DependencyProperty.Register("Text",
            typeof(string), typeof(Label), new PropertyMetadata(string.Empty));
        ...
        public static readonly DependencyProperty FontSpaceProperty = DependencyProperty.Register("FontSpace",
            typeof(int), typeof(Label), new PropertyMetadata(0));
        ...
        public static readonly DependencyProperty BackColorProperty = DependencyProperty.Register("BackColor",
            typeof(Brush), typeof(Label), new PropertyMetadata(Brushes.Transparent));
